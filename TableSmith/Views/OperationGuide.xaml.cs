            ...
            return new ObservableCollection<OperationGuideTopic>
            {
                ...
                new(
                    ...
                    new[]
                    {
                        ...
                        "decimal型は精度と小数桁数を設定します。自動採番、保護対象、保護方式も必要に応じて設定します。",
                        "PK・FKを設定します。FKは参照PKを選ぶと型、サイズ、精度などを継承します。",
                        "入力内容を確認して「作成」を選択します。"
                    },
                ...
                new(
                    ...
                    "型によって必要な項目が異なります。decimal型は精度が必須です。PKはNot Null、自動採番はPKかつ数値型を推奨します。",
                    new[]
                    {
                        ...
                        new OperationGuideItem("サイズ", "文字列型の最大長", "char、nchar、varchar、nvarcharの場合だけ入力できます。型を変更すると不要な値はクリアされます。"),
                        new OperationGuideItem("精度", "decimal型の全体桁数", "decimal型の場合だけ入力でき、1以上の値が必須です。例: decimal(10,2)の10。"),
                        new OperationGuideItem("小数桁数", "decimal型の小数部桁数", "decimal型の場合だけ入力できます。0以上かつ精度以下にします。"),
                        ...
                        new OperationGuideItem("参照PK", "参照先テーブルの主キー", "選択すると型、サイズ、精度、小数桁数、論理名などを参照元から継承します。"),
                ...
                new(
                    ...
                    "decimal精度、自動採番、PK・FK、論理名・説明、インデックスがRDB別の形式で出力されます。ファイル文字コードはDB基本設定の「SQL文字コード」を使用します。"),
                new(
                    "definition",
                    "テーブル定義書出力",
                    ...
                    new[]
                    {
                        ...
                        "スキーマ、文字コード、照合順序、精度、自動採番、保護設定が反映されていることを確認します。"
                    },
                ...
                new(
                    ...
                    "ER図は全テーブルを対象にします。decimal型は精度・小数桁数を表示しますが、インデックスは表示しません。")
            };
        }
